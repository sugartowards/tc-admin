...
/***/
function(e,t,n){"use strict";function r(e){return e&&e.__esModule?e:{default:e}}function o(e,t){var n={};for(var r in e)t.indexOf(r)>=0||Object.prototype.hasOwnProperty.call(e,r)&&(n[r]=e[r]);return n}function a(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function l(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var u,s,c=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},f=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),d=n(0),p=r(d),h=n(2),y=r(h),v=n(1),b=n(8),g=n(9),m=r(g),_=n(28),O=r(_),w=n(49),x=r(w),E=n(6),k=r(E),j=n(12),P=r(j),M=n(125),T=r(M),S=n(147),C=r(S),N=n(184),D=r(N),I=n(188),A=r(I),F=n(58),R=r(F);n(29);var L=(v.Layout.Header,v.Layout.Content),U="tab",B=(s=u=function(e){function t(e,n){a(this,t);var r=i(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e,n));return r._handleMenuClick=function(e){var t=e.item;r.addTab(t.props)},r._handleTabSelected=function(e){var t=r.refs[U].refs[O.default.TabPages].refs[e.options[O.default.TabPageIndex]],n=t.setErrCode,o=t.setLoading;k.default._setOptions(n,o)},r._handleUserUnauthorized=function(){localStorage.getItem(m.default._UserInfo)?R.default.changeLogin():r._handleLogout()},r._handleLogout=function(){localStorage.removeItem(m.default._UserInfo),R.default.changeLogin(!1);var e=r.props,t=e.history,n=e.location.pathname;n.endsWith("/")&&(n=n.substr(0,n.length-1)),
// 跳转到登录路径下、且移除历史路由
n.endsWith("/login")?t.replace(n):t.replace(n+"/login")},r.addTab=function(e){var t=e.title,n=e.url,a=e.app,i=e.attribute,l=void 0===i?{}:i,u=o(e,["title","url","app","attribute"]),s=l;a||(Object.assign(s,r.menuAttributeMap[n],{promiseFunc:r.appMap[n]}),a=x.default);var f=a;r.refs[U].addTab(c({title:t,App:f,options:s},u))},r.removeTab=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:r.getCurrentTab();r.refs[U].remove(e);var t=e.sourceTab;t&&r.refs[U].addTab(t)},r.getCurrentTab=function(){return r.refs[U].getCurrentTab()},r.updateUserInfo=function(e){e=Object.assign({},JSON.parse(localStorage.getItem(m.default._UserInfo)),e),localStorage.setItem(m.default._UserInfo,JSON.stringify(e)),r.setState({user:e})},r.state={menuData:[],user:r.userInfo},r.menuAttributeMap={},r.appMap={},!r.userInfo&&r._handleLogout(),r}return l(t,e),f(t,[{key:"getChildContext",value:function(){return{addTab:this.addTab,removeTab:this.removeTab,updateUserInfo:this.updateUserInfo}}}]),f(t,[{key:"componentWillMount",value:function(){this.silderOptions={logo:this.logo,title:this.title,menuClick:this._handleMenuClick},this.formOptions={app:this.loginApp},this.stateOptions={app:this.logoutApp,success:this._handleLogout,showUserInfo:this.showUserInfo},this.tabOptions={ref:U,onTabSelected:this._handleTabSelected}}},{key:"render",value:function(){var e=this.state,t=e.menuData,n=e.user;return p.default.createElement(b.Provider,{indexStore:R.default},p.default.createElement(v.Layout,{className:"ctnui-indexpage"},p.default.createElement(C.default,c({},this.silderOptions,{menuData:t})),p.default.createElement(v.Layout,{className:"indexpage-layout"},p.default.createElement(T.default,{user:n}),p.default.createElement(L,{className:"indexpage-content"},p.default.createElement(D.default,c({},this.formOptions,{user:n})),p.default.createElement(A.default,this.stateOptions),p.default.createElement(O.default,this.tabOptions)))))}},{key:"componentDidMount",value:function(){var e=this;this.app&&k.default.get(this.app,null,function(t){var n=e.handleLoginData(t);n.length&&R.default.changeMenuTitle(n[0].title),e.setState({menuData:n})},function(t){var n=t.errorCode,r=t.errorMessage;401==n?e._handleLogout():P.default.error(r)}),window.CtnUi.handleUserUnauthorized=this._handleUserUnauthorized}},{key:"handleLoginData",
//功能函数-----------------------------------------------------
/**
         * 处理登录结果
         * @param data
         */
value:function(e){return e}}]),t}(m.default),u.TabObj=U,u.HeaderComponent=T.default,u.SilderComponent=C.default,u.LoginFormComponent=D.default,u.StateComponent=A.default,u.childContextTypes={addTab:y.default.func,removeTab:y.default.func,updateUserInfo:y.default.func},s);t.default=B},/* 49 */
/***/
...
/***/
function(e,t,n){"use strict";function r(e){return e&&e.__esModule?e:{default:e}}function o(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function a(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function l(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(t,"__esModule",{value:!0});var u,s,c=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),f=n(0),d=r(f),p=n(2),h=r(p),y=n(1),v=n(6),b=(r(v),n(24)),g=r(b),m=n(109),_=r(m),O=n(110),w=r(O);n(14);var x=y.Form.Item,E="account",k="AuthCode",j=(s=u=function(e){function t(e){a(this,t);var n=i(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e));return n._handleSubmit=function(e){e.preventDefault(),n.refs[k].check(n._submit)},n._submit=function(e){if("string"==typeof e&&e)return void n.setState({errorMessage:e,loading:!1});n.props.form.validateFields({force:!0},function(e,t){if(!e){var r;n.setState({loading:!0});var a=n.options.psw.key,i=n.options.name.key;t[a]=g.default.hex_md5(t[i]+t[a]),n.props.success((r={},o(r,i,t[i]),o(r,a,t[a]),r))}})},n._renderMessage=function(e){return e?d.default.createElement(y.Alert,{style:{marginBottom:24},message:e,type:"error",showIcon:!0}):null},n.state={type:E,loading:!1,errorMessage:null},n}return l(t,e),c(t,[{key:"componentWillMount",value:function(){this.options={submit:this.submit,name:{key:"username",message:"请输入用户名！"},psw:{key:"password",message:"请输入密码！"}}}},{key:"render",value:function(){var e=this.state,t=e.type,n=e.errorMessage,r=e.loading,o=this.props,a=o.form.getFieldDecorator,i=o.imgApp,l=this.options,u=l.name,s=l.psw;return d.default.createElement(y.Form,{onSubmit:this._handleSubmit},this._renderMessage(n),d.default.createElement(_.default,{type:t,getFieldDecorator:a,name:u,psw:s}),d.default.createElement(x,{className:"additional"},d.default.createElement(w.default,{ref:k,app:i}),d.default.createElement(y.Button,{size:"large",loading:r,className:"submit",type:"primary",htmlType:"submit"},"登录")))}}]),t}(d.default.PureComponent),u.propTypes={app:h.default.string.isRequired,imgApp:h.default.string.isRequired,success:h.default.func.isRequired},s);t.default=y.Form.create()(j)},/* 109 */
/***/
